  ...
  <div class="mx-auto max-w-lg py-6 sm:px-6 lg:px-8">
    ...
    <div class="px-4 py-6 sm:px-0">
      <div class="grid grid-cols-4 gap-4">
        <div class="h-auto rounded border border-solid border-gray-300 p-5">01</div>
        <!-- ... -->
        <div class="h-auto rounded border border-solid border-gray-300 p-5">09</div>
      </div>
                  ...
                  <form
                    ...
                    <div class="mb-4">
                      <label class="block">
                        ...
                        <input type="text" name="title" id="title" class="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1" value="{{ $project->student->name ?? '' }}">
                      </label>
                    </div>
